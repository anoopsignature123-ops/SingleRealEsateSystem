...
class PlotTypeController extends Controller
{
    ...
    public function store(
        PlotTypeRequest $request
    ) {
        $this->plotTypeService->create(
            $request->validated()
        );

        return redirect()
            ->route('admin.plot-types.index')
            ->with(
                'success',
                'Plot type created successfully'
            );
    }
    ...
    public function update(
        ...
        return redirect()
            ...
            ->with(
                'success',
                'Plot type updated successfully'
            );
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()
            ...
            ->with(
                'success',
                'Plot type deleted successfully'
            );
    }
}
