                            ...
                            @forelse ($customers as $key => $customer)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <img src="https://ui-avatars.com/api/?name={{ urlencode($primary?->name ?? 'User') }}"
                                                width="45" height="45" class="rounded-circle border">
                                        @endif
                                    </td>

                                    <td class="fw-semibold">
                                        {{ ucfirst($primary?->name ?? ($customer->customer_name ?? 'N/A')) }}
                                    </td>
                                    ...
                                    <td>
                                        {{ ucfirst(str_replace('_', ' ', $customer->customer_type ?? 'N/A')) }}
                                    </td>
